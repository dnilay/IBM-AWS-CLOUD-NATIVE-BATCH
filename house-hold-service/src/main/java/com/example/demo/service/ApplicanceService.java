...
public class ApplicanceService {
	...
	/*
	 * public Map<String, Boolean> deleteById(Integer id){ ApplianceEntity
	 * applianceEntity = applianceRepository.findById(id) .orElseThrow(() -> new
	 * ResourceNotFoundException("Appliance not found for this id :: " + id));
	 * 
	 * applianceRepository.delete(applianceEntity); Map<String, Boolean> response =
